...
Citizen.CreateThread(function()
    if (GetCurrentResourceName() ~= "qb-inventory") then 
        print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named qb-inventory for it to work properly!");
        print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named qb-inventory for it to work properly!");
        print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named qb-inventory for it to work properly!");
        print("[" .. GetCurrentResourceName() .. "] " .. "IMPORTANT: This resource must be named qb-inventory for it to work properly!");
    end
...
GetRepoInformations = function()
    ...
    PerformHttpRequest("https://api.github.com/repos/P4ScriptsFivem/qb-inventory/releases/latest", function(err, response, headers)
        if err == 200 then
            ...
            repoURL = "https://api.github.com/repos/P4ScriptsFivem/qb-inventory/releases/latest"
        end
    end, "GET")
