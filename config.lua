...
Config.VehicleInventories = {
    vehicles = {
        -- specific vehicle overrides (optional)
        -- example:
        -- ["adder"] = {
        --     maxWeight = 150000,
        --     slots = 20
    ...
    classes = {
        [0] = { maxWeight = 100000, slots = 30 }, -- Compacts
        [1] = { maxWeight = 120000, slots = 35 }, -- Sedans
        [2] = { maxWeight = 150000, slots = 40 }, -- SUVs
        [3] = { maxWeight = 100000, slots = 30 }, -- Coupes
        [4] = { maxWeight = 100000, slots = 30 }, -- Muscle
        [5] = { maxWeight = 80000,  slots = 25 }, -- Sports Classics
        [6] = { maxWeight = 80000,  slots = 25 }, -- Sports
        [7] = { maxWeight = 60000,  slots = 20 }, -- Super
        [8] = { maxWeight = 20000,  slots = 10 }, -- Motorcycles
        [9] = { maxWeight = 150000, slots = 40 }, -- Off-road
        [10] = { maxWeight = 300000, slots = 60 }, -- Industrial
        [11] = { maxWeight = 200000, slots = 50 }, -- Utility
        [12] = { maxWeight = 250000, slots = 55 }, -- Vans
        [13] = { maxWeight = 0, slots = 0 }, -- Cycles
        [14] = { maxWeight = 500000, slots = 80 }, -- Boats
        [15] = { maxWeight = 500000, slots = 80 }, -- Helicopters
        [16] = { maxWeight = 500000, slots = 80 }, -- Planes
        [17] = { maxWeight = 120000, slots = 35 }, -- Service
        [18] = { maxWeight = 120000, slots = 35 }, -- Emergency
        [19] = { maxWeight = 300000, slots = 70 }, -- Military
        [20] = { maxWeight = 400000, slots = 80 }, -- Commercial
        [21] = { maxWeight = 0, slots = 0 }, -- Trains
    },
